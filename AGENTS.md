...
Server-side API rate limiter (TypeScript). Solution lives in `rate-limiter/`; specs are in `rate-limiter/specs/US-*.md`. Entry point / public API is `src/index.ts`. Human-facing run docs: `rate-limiter/README.md`.
